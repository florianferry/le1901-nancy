#!/usr/bin/env bash
PORT=$(cat "/Users/florianferry/Développement/le1901-nancy-main/.dual-graph/mcp_port" 2>/dev/null || echo 8081)
...
if [[ -f "/Users/florianferry/Développement/le1901-nancy-main/CONTEXT.md" ]]; then
  echo ""
  echo "=== CONTEXT.md ==="
  cat "/Users/florianferry/Développement/le1901-nancy-main/CONTEXT.md"
  echo "=== end CONTEXT.md ==="
fi
# Inject context store entries (decisions, tasks, next steps) — max 15 lines, 7-day window
STORE="/Users/florianferry/Développement/le1901-nancy-main/.dual-graph/context-store.json"
